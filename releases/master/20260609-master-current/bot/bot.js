...
import { handleStart, handleClear, handleClearCallback, handleProject, handleNexusProject, handleNewProject, handleProjectCallback, handleStatus, handleMode, handleQuiet, handleModeCallback, handleTTS, handleTTSCallback, handleTelegraph, handleTelegraphCallback, handleBotStatus, handleRestartBot, handleRestartCallback, handleContext, handlePing, handleCancel, handleCommands, handleModelCommand, handleModelCallback, handlePlan, handleExplore, handleResume, handleResumeCallback, handleContinue, handleLoop, handleSessions, handleTeleport, handleFile, handleReddit, handleVReddit, handleMedium, handleMediumCallback, handleTerminalUI, handleTerminalUICallback, handleTranscribe, handleTranscribeAudio, handleTranscribeDocument, handleExtract, handleExtractCallback, handleRedditActionCallback, handleReset, handleResetCallback, handleInbox, handleInboxCallback, handleWiki, handlePrivate, handleHealth, handleBrief, } from './handlers/command.handler.js';
...
function getSequentializeKey(ctx) {
...
export async function createBot() {
    ...
    bot.api.setMyCommands(commandList).then(async () => {
        ...
        try {
            ...
            console.log(`📋 Telegram backend reports ${live.length} commands: ` +
