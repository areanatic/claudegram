 ...
 */
export declare const CONTEXT_ROTATE_WARN = 0.8;
export declare const CONTEXT_ROTATE_HARD = 0.9;
 ...
 */
export declare function occupancyTokens(u: OccupancyInput): number;
/**
 ...
 */
export declare function classifyContextPressure(usedTokens: number, contextWindow: number): ContextPressure;
...
export declare const LARGE_CONTEXT_WINDOW = 1000000;
/**
 ...
 */
export declare function effectiveWindowTokens(model: string | undefined | null): number;
...
export declare const BOOT_AIRBAG_BASELINE_BYTES: number;
/**
 ...
 */
export declare function exceedsBootWindow(sizeBytes: number, model: string | undefined | null): boolean;
/**
 ...
 */
export declare function isContextOverflowSentinel(text: string | undefined | null): boolean;
/**
 ...
 */
export declare function shouldRetryAfterOverflow(opts: {
    isOverflowRetry: boolean;
    toolsUsedCount: number;
    hasText: boolean;
}): boolean;
//# sourceMappingURL=context-pressure.d.ts.map