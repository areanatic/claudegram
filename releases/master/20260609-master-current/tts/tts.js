...
async function generateSpeechOpenAI(text, voice) {
 ...
 */
export function chunkText(text, maxLen = GROQ_MAX_CHARS) {
 ...
 */
async function groqTTSSingle(text, voice) {
 ...
 */
async function concatAndConvertAudio(wavBuffers) {
 ...
 */
async function generateSpeechGroq(text, voice) {
