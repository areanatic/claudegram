 ...
 */
function replaceThematicBreaksOutsideCode(text) {
...
export function splitMessage(text, maxLength = MAX_MESSAGE_LENGTH) {
    ...
    while (remaining.length > 0) {
        ...
        let lastCodeBlockIndex = -1;
        let tempInCodeBlock = inCodeBlock;
        let tempLang = codeBlockLang;
 ...
 */
export function processMessageForTelegram(text, maxLength = MAX_MESSAGE_LENGTH) {
