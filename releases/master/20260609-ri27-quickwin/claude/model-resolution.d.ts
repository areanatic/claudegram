 ...
 */
export declare const DEFAULT_MODEL_FALLBACK = "sonnet";
export declare function resolveModel(override: string | undefined, perSession: string | undefined, configDefault: string | undefined): string;
