...
export function startScannerProWatcher() {
    const gate = gateOk();
    if (!gate.ok) {
...
export async function stopScannerProWatcher() {
    if (intervalTimer) {
...
export function getScannerWatcherStatus() {
    const gate = gateOk();
    return {
...
//# sourceMappingURL=scanner-pro-watcher.js.map