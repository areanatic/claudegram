...
export function isStaleMessage(messageDate) {
 ...
 */
export function shouldNotifyStale(sessionKey) {
...
export function getStaleAgeMinutes(messageDate) {
    const messageDateMs = messageDate * 1000;
...
//# sourceMappingURL=stale-filter.js.map