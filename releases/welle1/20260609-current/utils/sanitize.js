...
export function sanitizePath(str) {
    ...
    if (USERNAME && USERNAME.length > 2) {
        ...
        sanitized = sanitized.replace(new RegExp(`/Users/${escapeRegExp(USERNAME)}`, 'g'), '/Users/<user>');
        sanitized = sanitized.replace(new RegExp(`/home/${escapeRegExp(USERNAME)}`, 'g'), '/home/<user>');
    }
    return sanitized;
}
/**
