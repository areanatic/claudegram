...
async function loadFor(dir, tag) {
...
async function main() {
    ...
    check(!bHadWrite || JSON.parse(fs.readFileSync(path.join(botB, 'privacy-state.json'), 'utf-8'))[ARASH] === undefined, 'bot B state file never gained Arash private record from bot A');
    // Cleanup
...
//# sourceMappingURL=privacy-state-isolation.test.js.map